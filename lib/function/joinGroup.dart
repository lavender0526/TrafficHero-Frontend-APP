...
class joinGroup extends StatefulWidget {
  ...
  @override
  State<joinGroup> createState() => _joinGroup();
}
        ...
        child: Column(
          children: [
                ...
                child: Row(
                  children: [
                    ...
                    Align(
                      ...
                      // Text("退出群組",style: TextStyle(fontSize: 20,color:Colors.black,fontWeight: FontWeight.bold)),
                    ),
                      flex: 3,
                    ),
                  ],
            ...
            Container(
              ...
              //     children: <Widget>[
              //       ElevatedButton(
              //         child: Text('加油',style: TextStyle(fontSize: 15, color: Colors.black,)),
              //         onPressed: () { },
              //         style: ElevatedButton.styleFrom(
              //             backgroundColor: Color.fromRGBO(231, 231, 231, 1),
              //             shape:
              ...
              //       ),
              //       ElevatedButton(
              //         child: Text('等等',style: TextStyle(fontSize: 15, color: Colors.black,)),
              //         onPressed: () { },
              //         style: ElevatedButton.styleFrom(
              //             backgroundColor: Color.fromRGBO(231, 231, 231, 1),
              //             shape:
              ...
              //       ),
              //       ElevatedButton(
              //         child: Text('拋錨',style: TextStyle(fontSize: 15, color: Colors.black,)),
              //         onPressed: () { },
              //         style: ElevatedButton.styleFrom(
              //             backgroundColor: Color.fromRGBO(231, 231, 231, 1),
              //             shape:
              ...
              //       ),
              //       ElevatedButton(
              //         child: Text('廁所',style: TextStyle(fontSize: 15, color: Colors.black,)),
              //         onPressed: () { },
              //         style: ElevatedButton.styleFrom(
              //             backgroundColor: Color.fromRGBO(231, 231, 231, 1),
              //             shape:
